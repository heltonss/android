package br.com.heltonsouza.calculadoraviagem.watchers
...
class DecimalTextWatchers(editText: EditText, val totalDecimalNumber: Int = 2) : TextWatcher {
    ...
    private fun formatDigits(editable: Editable) {
        ...
        val dfnd = DecimalFormat("#,##.${getTotalDecimalNumber()}")
